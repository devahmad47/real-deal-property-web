...
export function SearchPageModel(props) {
    const { setOpen, connections, open } = props
                                                ...
                                                <div className=' '>
                                                    {
                                                        connections.map((con, index) => {
                                                            ...
                                                            }} key={index} className="flex my-3 items-center justify-center md:justify-between gap-2  bg-gray-300     rounded-lg p-2 shadow-lg cursor-pointer">
