...
import { login, addNotification } from '../../Store/authSlice';
...
export function LoginWebsite() {
  ...
  async function handelSubmit(e) {
    ...
    try {
      setLoading(true)
      const response = await axios.post(`${serverURL}/api/auth/signin`, loginData);
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to={"/ForgetPassword"} className="font-semibold text-cyan-700 hover:text-indigo-500">
                  Forgot password?
                </Link>
              </div>
            </div>
